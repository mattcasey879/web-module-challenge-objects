...
createMenuItem('gumbo',10.99,'supper');
...
export const burger = {
  ...
  discount: function(string){
    if (string === 'teacher' || string === 'student'){
      let discount = burger.price * .25;
      return burger.price - discount;
    } else{
      let discount = burger.price * .10; 
      return burger.price - discount;
